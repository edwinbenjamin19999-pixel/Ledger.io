...
export const bokforaFaktura: Article = {
  ...
  metaTitle: "Hur bokför man en faktura? Komplett guide | Ledger.io",
  metaDescription:
  ...
  internalLinks: {
    ...
    product: { label: "Automatisera fakturahantering med Ledger.io", href: "/features/accounting-automation" },
