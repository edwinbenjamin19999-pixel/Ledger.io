...
export const bokforaFaktura: Article = {
  ...
  metaTitle: "Hur bokför man en faktura? Komplett guide | NorthLedger",
  metaDescription:
  ...
  internalLinks: {
    ...
    product: { label: "Automatisera fakturahantering med NorthLedger", href: "/features/accounting-automation" },
