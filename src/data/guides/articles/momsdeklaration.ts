...
export const momsdeklaration: Article = {
  ...
  metaTitle: "Momsdeklaration steg för steg — SKV 4700 | NorthLedger",
  metaDescription:
  ...
  northledgerSolution: {
    intro: "NorthLedger sammanställer SKV 4700 automatiskt från huvudboken och kan lämna in via Skatteverkets API direkt — du godkänner med BankID.",
    comparison: [
  ...
  internalLinks: {
    ...
    product: { label: "Se NorthLedger momsautomation", href: "/resources/vat-guide" },
