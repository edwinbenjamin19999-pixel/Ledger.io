...
export const debetKredit: Article = {
  ...
  metaTitle: "Debet och kredit förklarat — komplett guide | Cogniq",
  metaDescription:
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Det hjälper, men moderna AI-verktyg som Cogniq hanterar regelverket åt dig. Du behöver främst förstå vad som händer — inte exakt vilket konto som debiteras.",
    },
  ],
  internalLinks: {
    related: ["vad-ar-bokforing", "bokfora-kvitto", "bokfora-faktura"],
    product: { label: "Låt Cogniq hantera kontoval åt dig", href: "/features/accounting-automation" },
