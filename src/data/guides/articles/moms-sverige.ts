...
export const momsSverige: Article = {
  ...
  metaTitle: "Moms i Sverige — komplett guide 2026 | Bokfy",
  metaDescription:
  ...
  faq: [
    ...
    {
      q: "Kan Bokfy sköta momsdeklarationen automatiskt?",
      a: "Ja. Bokfy sammanställer SKV 4700 automatiskt från bokföringen och kan lämna in deklarationen direkt till Skatteverket via API.",
    },
  ],
  internalLinks: {
    related: ["bokfora-faktura", "bokfora-kvitto", "vad-ar-bokforing"],
    product: { label: "Automatisera momshantering med Bokfy", href: "/resources/vat-guide" },
