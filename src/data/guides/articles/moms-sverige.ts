...
export const momsSverige: Article = {
  ...
  metaTitle: "Moms i Sverige — komplett guide 2026 | Cogniq",
  metaDescription:
  ...
  faq: [
    ...
    {
      q: "Kan Cogniq sköta momsdeklarationen automatiskt?",
      a: "Ja. Cogniq sammanställer SKV 4700 automatiskt från bokföringen och kan lämna in deklarationen direkt till Skatteverket via API.",
    },
  ],
  internalLinks: {
    related: ["bokfora-faktura", "bokfora-kvitto", "vad-ar-bokforing"],
    product: { label: "Automatisera momshantering med Cogniq", href: "/resources/vat-guide" },
