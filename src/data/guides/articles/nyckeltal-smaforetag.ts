...
export const nyckeltalSmaforetag: Article = {
  ...
  metaTitle: "Nyckeltal för småföretag — komplett guide | Bokfy",
  metaDescription:
  ...
  northledgerSolution: {
    intro: "Bokfy:s CFO-modul räknar ut alla nyckeltal automatiskt varje natt och varnar när något avviker mer än 15 % från trenden.",
    comparison: [
  ...
  internalLinks: {
    ...
    product: { label: "Se Bokfy CFO-dashboard", href: "/auth" },
