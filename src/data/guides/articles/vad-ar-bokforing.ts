...
export const vadArBokforing: Article = {
  ...
  metaTitle: "Vad är bokföring? Enkelt förklarat 2026 | NorthLedger",
  metaDescription:
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Ja, men det kräver tid och kunskap. AI-verktyg som NorthLedger kan automatisera 95 % av arbetet — du fokuserar på att granska och godkänna istället för att mata in data manuellt.",
    },
  ],
  internalLinks: {
    related: ["debet-kredit", "bokfora-kvitto", "moms-sverige"],
    product: { label: "Se hur NorthLedger sköter bokföringen åt dig", href: "/features/accounting-automation" },
