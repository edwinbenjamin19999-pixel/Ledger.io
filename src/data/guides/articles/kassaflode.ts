...
export const kassaflode: Article = {
  ...
  metaTitle: "Kassaflöde — komplett guide för småföretag | NorthLedger",
  metaDescription:
  ...
  northledgerSolution: {
    intro: "NorthLedger byggde kassaflödesprognosen direkt in i bokföringen. Den uppdateras live i takt med att fakturor skickas, betalas och avstäms.",
    comparison: [
  ...
  faq: [
    ...
    { q: "Hur ofta ska jag göra en kassaflödesprognos?", a: "Minst varje månad — och vid större beslut. NorthLedger uppdaterar prognosen i realtid så du alltid ser 12 månader framåt." },
  ...
  internalLinks: {
    ...
    product: { label: "Se NorthLedger kassaflödesprognos", href: "/auth" },
