...
export const TEMPLATE_ARTICLE: Article = {
  ...
  // === 6. NorthLedger Solution ===
  northledgerSolution: {
    intro: "TODO — one paragraph on how NorthLedger removes the work.",
    comparison: [
      { manual: "TODO manual pain", northledger: "TODO NorthLedger benefit" },
      { manual: "TODO manual pain", northledger: "TODO NorthLedger benefit" },
      { manual: "TODO manual pain", northledger: "TODO NorthLedger benefit" },
    ],
  },
  ...
  internalLinks: {
    ...
    product: { label: "Se NorthLedger bokföring", href: "/auth" },
