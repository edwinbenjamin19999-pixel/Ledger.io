...
export const euMomsOmvandSkattskyldighet: Article = {
  ...
  metaTitle: "EU-moms & omvänd skattskyldighet — guide | Cogniq",
  metaDescription:
  ...
  northledgerSolution: {
    intro: "Cogniq känner igen EU-leverantörer automatiskt, validerar VAT-nummer och bokför omvänd skattskyldighet utan manuell hantering.",
    comparison: [
  ...
  internalLinks: {
    ...
    product: { label: "Se Cogniq EU-momsautomation", href: "/auth" },
