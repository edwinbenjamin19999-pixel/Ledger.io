...
export const bokforaKvitto: Article = {
  ...
  metaTitle: "Hur bokför man ett kvitto? Komplett guide 2026 | NorthLedger",
  metaDescription:
  ...
  faq: [
    ...
    {
      q: "Kan NorthLedger bokföra kvitton automatiskt?",
  ...
  internalLinks: {
    ...
    product: { label: "Se hur NorthLedger bokför kvitton automatiskt", href: "/features/accounting-automation" },
