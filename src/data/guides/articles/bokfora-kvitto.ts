...
export const bokforaKvitto: Article = {
  ...
  metaTitle: "Hur bokför man ett kvitto? Komplett guide 2026 | Ledger.io",
  metaDescription:
  ...
  faq: [
    ...
    {
      q: "Kan Ledger.io bokföra kvitton automatiskt?",
  ...
  internalLinks: {
    ...
    product: { label: "Se hur Ledger.io bokför kvitton automatiskt", href: "/features/accounting-automation" },
