...
export const avdragsgillMoms: CompactGuide = {
  ...
  metaTitle: "Avdragsgill moms — komplett guide | NorthLedger",
  metaDescription:
  ...
  northledgerNote:
    "NorthLedger känner igen kvitton som faller under specialregler (representation, bil, gåva) och tillämpar rätt momsavdrag automatiskt.",
