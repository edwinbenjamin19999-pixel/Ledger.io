...
export const resultatrapport: CompactGuide = {
  ...
  metaTitle: "Resultatrapport — så analyserar du | Ledger.io",
  metaDescription:
  ...
  northledgerNote:
    "Ledger.io levererar månatlig resultatrapport med automatisk avvikelseanalys mot budget och föregående år — och förklarar varför resultatet ändrats.",
