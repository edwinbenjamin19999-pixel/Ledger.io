...
export const resultatrapport: CompactGuide = {
  ...
  metaTitle: "Resultatrapport — så analyserar du | NorthLedger",
  metaDescription:
  ...
  northledgerNote:
    "NorthLedger levererar månatlig resultatrapport med automatisk avvikelseanalys mot budget och föregående år — och förklarar varför resultatet ändrats.",
