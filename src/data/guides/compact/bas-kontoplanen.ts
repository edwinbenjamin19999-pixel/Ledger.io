...
export const basKontoplanen: CompactGuide = {
  ...
  metaTitle: "BAS-kontoplanen — komplett guide | Bokfy",
  metaDescription:
  ...
  northledgerNote:
    "Bokfy väljer rätt BAS-konto automatiskt baserat på leverantör, belopp och kategori — och lär sig av dina korrigeringar.",
