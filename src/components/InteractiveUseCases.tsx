  ...
  return (
    <div className="mt-4 pt-4 border-t border-white/[0.06] space-y-3">
      ...
      {useCase.status && visibleSteps >= useCase.demoSteps.length && (
        <div className="mt-2 px-3 py-2 rounded-lg bg-[rgba(37,99,235,0.1)] border border-[rgba(37,99,235,0.15)]">
  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl border bg-white/[0.04] backdrop-blur-sm cursor-pointer transition-all duration-250 ease-out ${
        ...
        isActive
          ? "border-[rgba(37,99,235,0.3)] shadow-[0_0_30px_rgba(37,99,235,0.15)]"
          : "border-white/10 hover:border-white/20 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(37,99,235,0.1)]"
      } ${isDimmed ? "opacity-60 scale-[0.98]" : ""}`}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className={`${large ? "w-10 h-10" : "w-8 h-8"} rounded-xl bg-[rgba(37,99,235,0.15)] flex items-center justify-center`}>
