              ...
              : attention.slice(0, 3).map((a) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        onClick={a.onAction}
                        className="w-full h-[44px] rounded-xl bg-[#3b82f6] active:bg-[#2563eb] text-white text-[15px] font-medium transition-colors"
                      >
                        {a.actionLabel}
                      </button>
                    </div>
        ...
        {openSheet && (
          <div className="px-5 pb-6">
            ...
            <button
              ...
              className="mt-6 w-full h-[48px] rounded-xl bg-[#3b82f6] active:bg-[#2563eb] text-white text-[15px] font-medium"
            >
              Öppna detaljvy
            </button>
          </div>
