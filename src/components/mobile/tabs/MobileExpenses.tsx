...
const CATEGORIES = [
  ...
  { id: "Kontorsmaterial", color: "bg-teal-500" },
...
export const MobileExpenses = ({ user }: MobileExpensesProps) => {
  ...
  const statusBadge = (s: string) => {
    ...
    return <span className="text-[10px] text-[#0B4F6C] bg-[#EFF6FF] px-[8px] py-[2px] rounded-full font-medium">Väntar på godkännande</span>;
  };
        ...
        <div className="px-4 pt-4 pb-6 bg-[#F8FAFB] min-h-full">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="flex items-center gap-[4px] bg-[#0B4F6C] text-white text-[12px] font-medium rounded-full px-[12px] h-[32px] active:bg-[#1074A0]"
            >
          ...
          <div className="mt-3 space-y-[8px]">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <button
                  onClick={() => setSheetOpen(true)}
                  className="mt-4 text-[12px] text-[#0B4F6C] font-medium"
                >
      ...
      <div className="px-5 pb-6">
        ...
        <label className="block">
          ...
          <input
            ...
            placeholder="0"
            className="w-full mt-1 bg-transparent text-[28px] font-medium text-[#0F172A] tabular-nums focus:outline-none border-b border-[#E2E8F0] focus:border-[#0B4F6C] py-1"
          />
        </label>
        ...
        <label className="block mt-5">
          ...
          <input
            ...
            className="w-full mt-1 bg-white border-[0.5px] border-[#E2E8F0] rounded-[10px] px-3 h-[44px] text-[14px] text-[#0F172A] focus:outline-none focus:border-[#0B4F6C]"
          />
        </label>
          ...
          >
            {photoPreview ? (
              ...
              <>
                ...
                {analyzing && <Loader2 className="h-4 w-4 animate-spin text-[#0B4F6C]" />}
              </>
            )}
          </button>
        </div>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="mt-6 w-full h-[52px] bg-[#0B4F6C] text-white rounded-[12px] text-[15px] font-medium active:bg-[#1074A0] disabled:opacity-60 flex items-center justify-center gap-2"
        >
