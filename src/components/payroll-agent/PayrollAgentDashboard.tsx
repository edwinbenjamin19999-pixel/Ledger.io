        ...
        <TabsList className="bg-transparent p-0 h-auto rounded-none border-b-[0.5px] border-[#E2E8F0] flex gap-0 w-full justify-start">
          {[
            ...
            <TabsTrigger
              key={t.v}
              value={t.v}
              className="rounded-none bg-transparent px-[12px] py-[7px] text-[11px] text-[#475569] border-b-2 border-transparent -mb-px data-[state=active]:text-[#0B4F6C] data-[state=active]:font-medium data-[state=active]:border-[#0B4F6C] data-[state=active]:bg-transparent data-[state=active]:shadow-none"
            >
              {t.l}
            </TabsTrigger>
          ))}
