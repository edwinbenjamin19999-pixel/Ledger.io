      ...
      <div className="bg-[#FAFBFC] border-[0.5px] border-[#DFE4EA] rounded-[12px] p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-[#0040CC]">Ansluten till Fortnox</p>
    ...
    <div className="bg-[#FAFBFC] border-[0.5px] border-[#DFE4EA] rounded-[12px] p-5 space-y-4">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <p className="text-[10px] text-[#94A3B8]">
          Cogniq begär endast läsbehörighet. Vi kan aldrig ändra data i Fortnox.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div>
      ...
      <div className="h-[3px] bg-[#DBEAFE] rounded-full overflow-hidden">
        <div
          className="h-full bg-[#0040CC] transition-all duration-500"
          style={{ width: `${pct}%` }}
        />
      </div>
    </div>
