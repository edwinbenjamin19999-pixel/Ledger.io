      ...
      <div className="bg-[#FAFBFC] border-[0.5px] border-[#DFE4EA] rounded-[12px] p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-[#0B4F6C]">Ansluten till Visma eEkonomi</p>
              {conn.vismaCompanyId && (
  ...
  return (
    <div>
      ...
      <div className="h-[3px] bg-[#DBEAFE] rounded-full overflow-hidden">
        <div className="h-full bg-[#0B4F6C] transition-all duration-500" style={{ width: `${pct}%` }} />
      </div>
    </div>
  );
};
