        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="space-y-5 sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2.5 text-sm text-white/60">
              ...
              <a href="mailto:info@northledger.se" className="flex items-center gap-2 hover:text-[#3b82f6] transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/northledger.se?igsh=Y2lrNHZ2OGpkaTBz&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[#3b82f6] transition-colors">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
