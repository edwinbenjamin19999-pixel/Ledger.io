...
export const AIEkonomSection = () => {
  ...
  return (
    <section id="ai-ekonom" className="relative overflow-hidden bg-[#0B1D2A] py-24 px-6 md:py-28">
      <div
        aria-hidden
        className="pointer-events-none absolute -right-[6%] top-0 h-[460px] w-[460px] rounded-full bg-[#0052FF]/[0.10] blur-[130px]"
      />
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-16">
        {/* Text */}
        <div>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-[#0052FF]/15 px-3 py-1 text-xs font-medium text-[#7DA5FF]">
          ...
          <ul className="mt-8 flex flex-col gap-3.5">
            {POINTS.map((p) => (
              <li key={p} className="flex items-center gap-3">
                <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#0052FF]/20 text-[#7DA5FF]">
          ...
          <button
            ...
            className="group mt-9 inline-flex h-12 items-center gap-2 rounded-xl bg-[#0052FF] px-7 text-[15px] font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#0040CC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0052FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B1D2A]"
          >
        ...
        {/* Chatt-mockup */}
        <div className="rounded-2xl border border-white/10 bg-white p-4 shadow-[0_40px_80px_-32px_rgba(0,0,0,0.6)]">
