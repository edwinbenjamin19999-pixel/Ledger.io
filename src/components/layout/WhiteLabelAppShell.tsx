 ...
 *  - Topbar: tenant identity dominant, no Bokfy chrome, brand-tinted border
 ...
 *  - "Powered by Bokfy" attribution lives discreetly in the user menu footer
    ...
    <SidebarProvider style={{ "--sidebar-width": "16.5rem" } as React.CSSProperties}>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {/* Tenant-branded topbar — dominant tenant identity, no Bokfy chrome */}
          <header
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64">
                  ...
                  <div className="px-2 py-1.5 text-[10px] text-muted-foreground/60 text-center tracking-wide">
                    {tenant.login.footer_attribution || "Powered by Bokfy"}
                  </div>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
