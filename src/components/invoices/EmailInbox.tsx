          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={`faktura-${(companyName || "bolag").toLowerCase().replace(/\s+/g, "-")}@inbox.northledger.se`}
              />
            </div>
            <div className="bg-muted/50 p-3 rounded text-xs text-muted-foreground space-y-1">
              <p><strong>Så fungerar det:</strong></p>
              <p>1. Ange en unik e-postadress ovan (t.ex. faktura-ertbolag@inbox.northledger.se)</p>
