...
export const WhySwitch = () => { const advantages = [
    { icon: Brain,
      ...
      description: "Traditionella system byggdes med manuella flöden och AI adderat efteråt. NorthLedger är designat med AI som kärnan — bokföringen sker automatiskt, inte manuellt.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4">
            <Badge variant="outline" className="mb-4">Varför NorthLedger?</Badge>
          ...
          <div className="max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-8">NorthLedger vs traditionella system</h3>
            <Card className="border-border/50 overflow-hidden">
              <div className="grid grid-cols-[1fr_auto_auto] text-sm">
                ...
                <div className="p-3 font-semibold bg-muted/50 border-b border-border/50 text-center w-24">NorthLedger</div>
