...
export const DNSInstructions = ({ domain, verificationToken }: Props) => {
  ...
  const records: DNSRecord[] = [
    { type: "CNAME", name: domain, value: "cogniq.se" },
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        Efter verifiering: kontakta support på <a href="mailto:support@cogniq.se" className="underline">support@cogniq.se</a> för SSL-aktivering på den anpassade domänen.
      </p>
    </div>
  );
};
