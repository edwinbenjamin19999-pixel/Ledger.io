    ...
    <div className="flex flex-wrap gap-2">
      {data.actions.map((a, i) => (
        <button
          ...
          className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-full border border-slate-200 bg-white hover:border-[#3b82f6] hover:bg-cyan-50/60 hover:text-[#3b82f6] text-slate-700 transition-colors"
        >
          {a.label}
