                            ...
                            <div className="flex items-center gap-2">
                              {alert.client_name && (
                                <button
                                  ...
                                  className="text-[12px] font-medium text-[#0F172A] hover:text-[#1D4ED8] truncate"
                                >
                                  {alert.client_name}
                                </button>
                              )}
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            {alert.action_url && (
                              <button
                                ...
                                className="bg-[#1D4ED8] hover:bg-[#1074A0] text-[#E6F4FA] rounded-[6px] text-[10px] font-medium px-[10px] h-[24px] flex items-center gap-1"
                              >
