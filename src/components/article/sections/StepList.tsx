      ...
      {steps.map((step, i) => (
        ...
        >
          <div className="flex items-start gap-5">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#3b82f6] to-[#3b82f6] text-sm font-semibold text-white shadow-[0_4px_12px_-2px_rgba(8,145,178,0.4)]">
              {i + 1}
            </div>
            <div className="flex-1 min-w-0">
              <h3 className="text-[17px] font-semibold text-[#0f1f35] tracking-tight">{step.title}</h3>
