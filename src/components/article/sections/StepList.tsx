      ...
      {steps.map((step, i) => (
        ...
        >
          <div className="flex items-start gap-5">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#3b82f6] to-[#3b82f6] text-sm font-semibold text-white shadow-[0_4px_12px_-2px_rgba(0,82,255,0.4)]">
              {i + 1}
            </div>
