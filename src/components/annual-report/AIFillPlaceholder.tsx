  ...
  return (
    ...
    >
      ...
      <button
        onClick={trigger}
        disabled={loading}
        className="inline-flex items-center gap-1 text-[#1D4ED8] hover:underline font-medium disabled:opacity-60"
      >
      ...
      {onManual && (
        <>
          ...
          <button onClick={onManual} className="text-[#1D4ED8] hover:underline font-medium">
            skriv manuellt
          </button>
        </>
      )}
