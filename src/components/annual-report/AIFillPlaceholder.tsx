  ...
  return (
    ...
    >
      ...
      <button
        onClick={trigger}
        disabled={loading}
        className="inline-flex items-center gap-1 text-[#0B4F6C] hover:underline font-medium disabled:opacity-60"
      >
      ...
      {onManual && (
        <>
          ...
          <button onClick={onManual} className="text-[#0B4F6C] hover:underline font-medium">
            skriv manuellt
          </button>
        </>
      )}
