    ...
    <div className="flex flex-col md:flex-row items-start md:items-center gap-5 md:gap-8">
      <div className="flex items-start gap-4 flex-1">
        ...
        <div className="flex-1">
          <div className="text-[17px] font-semibold text-[#0f1f35] tracking-tight">Vill du slippa detta manuellt?</div>
          <p className="mt-1.5 text-[15px] text-slate-600 leading-relaxed">{text}</p>
        </div>
      </div>
      <Link
        to={href}
        className="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-[#050d1a] px-5 py-3 text-sm font-semibold text-white hover:bg-[#050d1a]/90 transition-all duration-200"
      >
