  ...
  <section className="relative bg-[#0f1f35] overflow-hidden">
    ...
    <div className="relative container mx-auto max-w-5xl px-6 pt-32 pb-24 md:pt-40 md:pb-32 text-center">
      ...
      <p className="mt-6 max-w-2xl mx-auto text-lg text-white/60 leading-relaxed">
        NorthLedger är en AI-driven ekonomiplattform byggd för svenska bolag – där bokföring, moms och rapportering sker automatiskt, korrekt och i realtid.
      </p>
      <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
        ...
        >
          Testa NorthLedger <ArrowRight className="w-4 h-4" />
        </Link>
        <a
          href="mailto:demo@northledger.se?subject=Demo NorthLedger"
