...
export function RegulatoryIntelligence({ companyId }: RegulatoryIntelligenceProps) { const { toast } = useToast();
  ...
  function generateAlerts(_company: any, empCount: number, salaryTotal: number) { const generatedAlerts: RegulatoryAlert[] = [
      ...
      { id: "styrrantan-2026", source: "Riksbanken", sourceIcon: TrendingUp,
        ...
        autoActions: [{ label: "Uppdatera dröjsmålsränta", description: "Cogniq justerar automatiskt", done: true }],
        dismissed: false,
      ...
      { id: "edag-reporting", source: "Skatteverket", sourceIcon: Landmark,
        ...
        autoActions: [{ label: "Uppdatera AGI-format", description: "Automatiskt genomfort av Cogniq", done: true }],
        dismissed: false,
      },
  ...
  function generateDeadlines() { const year = currentYear;
    const deadlineList: ComplianceDeadline[] = [
      { id: "moms-q1", title: "Momsdeklaration Q1", description: "Momsdeklaration januari--mars", dueDate: `${year}-05-12`, category: "Moms", status: "upcoming", recurring: true, source: "Skatteverket", daysLeft: 0, autoAction: "Cogniq kan forbereda momsrapporten automatiskt", externalLink: "https://www.skatteverket.se/foretag/moms", steps: ["Stam av momskonton (2610-2650)", "Kontrollera ingaende moms", "Skicka in via Skatteverkets e-tjanst"] },
      ...
      { id: "årsredovisning", title: "Inregistrering av årsredovisning", description: "Registreras hos Bolagsverket", dueDate: `${year}-07-31`, category: "Arsredovisning", status: "upcoming", recurring: true, source: "Bolagsverket", daysLeft: 0, autoAction: "Generera årsredovisning i Cogniq", externalLink: "https://www.bolagsverket.se/foretag/aktiebolag/årsredovisning" },
