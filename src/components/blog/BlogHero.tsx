...
export const BlogHero = ({ eyebrow = "Insikter", title, subtitle }: Props) => (
  <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white pt-32 pb-16">
    ...
    <div className="container mx-auto max-w-4xl px-6 text-center">
      <div className="inline-flex items-center gap-1.5 rounded-full border border-cyan-200/60 bg-cyan-50 px-3 py-1 text-xs font-medium text-[#3b82f6]">
        <Sparkles className="w-3 h-3" />
        {eyebrow}
      </div>
      <h1 className="mt-5 text-4xl md:text-5xl font-bold tracking-tight text-[#0f1f35]">{title}</h1>
