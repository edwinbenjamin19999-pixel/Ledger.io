  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-0">
        <div className="relative h-64 md:h-full bg-gradient-to-br from-[#0F172A] via-[#3b82f6] to-[#3b82f6] flex items-center justify-center p-10">
        ...
        <div className="p-8 md:p-10 flex flex-col">
          ...
          <h2 className="mt-4 text-2xl md:text-3xl font-bold text-[#0F172A] tracking-tight leading-tight group-hover:text-[#3b82f6] transition-colors">
            {article.title}
          </h2>
