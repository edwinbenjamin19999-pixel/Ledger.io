...
export function MetricImpactStrip({ health }: Props) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
      ...
      <Link
        to="/agents/review"
        className={`rounded-xl border px-4 py-3 text-left group focus:outline-none focus:ring-2 focus:ring-[#2563EB]/40 transition hover:-translate-y-px hover:shadow-sm ${
