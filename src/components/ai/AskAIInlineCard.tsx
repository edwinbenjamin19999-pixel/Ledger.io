          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {questions.map((q, i) => (
              <button
                key={i}
                onClick={() => ask(q)}
                className="group inline-flex items-center gap-1.5 text-[12px] px-3 py-1.5 rounded-full border border-[#3b82f6]/30 bg-white hover:bg-[#3b82f6]/10 text-[#1d4ed8] font-medium transition-colors"
              >
                {q}
