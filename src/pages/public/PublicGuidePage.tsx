        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-10">
              <h1 className="text-3xl sm:text-4xl font-bold text-[#0F1B2D] mb-3">
                Så fungerar Bokfy
              </h1>
                ...
                >
                  <AccordionTrigger className="px-6 py-5 hover:no-underline gap-3">
                    <div className="flex items-center gap-3 flex-1 text-left">
                      ...
                      <div>
                        <span className="font-semibold text-[#0F1B2D] text-base">{cat.label}</span>
                          ...
                          <div className="rounded-lg hover:bg-slate-50 transition-colors">
                            <CollapsibleTrigger className="flex items-start gap-3 p-3 w-full text-left group">
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-[#0F1B2D] group-hover:text-[#3b82f6] transition-colors">
                                  {item.title}
                                </p>
                              ...
                              <div className="px-3 pb-3 space-y-3">
                                {item.steps && item.steps.length > 0 && (
                                  <div className="bg-slate-50 rounded-lg p-3">
                                    <p className="text-xs font-semibold text-[#0F1B2D] mb-2">Steg-för-steg</p>
                                    <ol className="space-y-1.5">
                                      {item.steps.map((step, si) => (
                                        <li key={si} className="flex gap-2 text-xs text-[#475569] leading-relaxed">
                                          <span className="w-5 h-5 rounded-full bg-[rgba(37,99,235,0.1)] text-[#3b82f6] flex items-center justify-center shrink-0 text-[10px] font-bold mt-0.5">
                                            {si + 1}
                                          </span>
                                          {step}
                                        </li>
            ...
            {filteredFaq.length > 0 && (
              <div className="mb-16">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-[#0F1B2D]">Vanliga frågor</h2>
                </div>
                <Accordion type="single" collapsible className="space-y-2">
                  {filteredFaq.map((f, i) => (
                    ...
                    >
                      <AccordionTrigger className="px-4 py-3 hover:no-underline text-left text-sm font-medium text-[#0F1B2D]">
                        {f.q}
                      </AccordionTrigger>
            ...
            <div className="text-center">
              <p className="text-[#0F1B2D] font-semibold text-lg mb-4">
                Redo att komma igång?
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Button
                  asChild
                  className="h-11 px-6 bg-[#3b82f6] text-white hover:bg-[#3b82f6] rounded-lg shadow-[0_4px_20px_rgba(37,99,235,0.3)]"
                >
                  <a href="/auth">
                    Logga in
                ...
                <Button
                  asChild
                  variant="outline"
                  className="h-11 px-6 rounded-lg border-[#C8DDF5] text-[#3b82f6] hover:bg-[#EFF6FF] hover:shadow-[0_0_12px_rgba(37,99,235,0.12)] hover:scale-[1.02] transition-all duration-200"
                >
