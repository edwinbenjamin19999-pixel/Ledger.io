      ...
      <main className="flex-1">
        ...
        <section className="py-12">
          <div className="container mx-auto max-w-3xl px-6">
            <h2 className="text-3xl font-bold text-[#0F1B2D] tracking-tight">Vad är AI-bokföring?</h2>
        ...
        <section className="py-12 bg-slate-50/60 border-y border-slate-100">
          <div className="container mx-auto max-w-5xl px-6">
            <div className="text-center max-w-xl mx-auto mb-10">
              <h2 className="text-3xl font-bold text-[#0F1B2D] tracking-tight">Hur det fungerar</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto max-w-6xl px-6">
            <div className="text-center max-w-xl mx-auto mb-10">
              <h2 className="text-3xl font-bold text-[#0F1B2D] tracking-tight">Vad som automatiseras</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {AUTO.map((a) => (
                <div key={a.title} className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="mt-4 font-semibold text-[#0F1B2D]">{a.title}</h3>
        ...
        <section className="py-16 bg-slate-50/60 border-y border-slate-100">
          <div className="container mx-auto max-w-4xl px-6">
            <div className="text-center max-w-xl mx-auto mb-8">
              <h2 className="text-3xl font-bold text-[#0F1B2D] tracking-tight">AI vs traditionellt system</h2>
          ...
          <div className="container mx-auto max-w-4xl px-6 grid sm:grid-cols-3 gap-4 text-center">
            {[{i: Shield, t: "GDPR-säker", d: "Krypterad data, EU-hosting"}, {i: Zap, t: "30 min onboarding", d: "Vi importerar din historik"}, {i: Clock, t: "10+ h/mån sparat", d: "Genomsnitt SME-kund"}].map((x) => (
              <div key={x.t} className="rounded-2xl border border-slate-100 p-6">
                ...
                <div className="mt-3 font-semibold text-[#0F1B2D]">{x.t}</div>
        ...
        <section className="py-16">
          <div className="container mx-auto max-w-3xl px-6">
            <h2 className="text-3xl font-bold text-[#0F1B2D] tracking-tight mb-6">Vanliga frågor</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto max-w-3xl px-6">
            <div className="rounded-3xl bg-[#0F1B2D] p-10 md:p-14 text-center text-white">
