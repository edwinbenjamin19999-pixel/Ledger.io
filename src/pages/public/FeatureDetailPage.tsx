...
const featureMap: Record<string, { title: string; description: string; icon: typeof Bot }> = {
  "ai-assistant": { title: "AI-assistent", description: "NorthLedger:s AI-assistent hjälper dig med bokföringsfrågor, konterar automatiskt och ger intelligenta förslag baserat på ditt företags historik.", icon: Bot },
