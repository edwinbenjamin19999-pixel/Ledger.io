...
const guidesMap: Record<string, { title: string; description: string }> = {
  ...
  "/resources/vat-guide": { title: "Svensk momsguide", description: "En komplett guide till svensk moms — momsperioder, avdrag, EU-moms och hur Bokfy hanterar momsberäkning automatiskt." },
  ...
  "/resources/accounting-compliance": { title: "Regelefterlevnad", description: "Information om hur Bokfy följer svensk redovisningsstandard, BAS-kontoplan och K2/K3-regelverk." },
};
