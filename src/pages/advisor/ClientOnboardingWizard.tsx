  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="rounded-3xl bg-white border border-[#E2E8F0] p-8 space-y-5">
        ...
        {step === 1 && (
          <>
            <h2 className="text-lg font-bold text-[#0F172A]">Bjud in klient till NorthLedger</h2>
            <div className="rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] p-4 flex items-center justify-between">
              <div>
                <div className="text-sm font-semibold text-[#0F172A]">Klienten ska ha tillgång till NorthLedger</div>
            ...
            {data.invite_to_northledger && (
              <div className="rounded-2xl border border-[#E2E8F0] p-4 text-sm text-[#475569]">
                En byrå-brandad inbjudan skickas till <span className="font-semibold text-[#0F172A]">{data.contact_email || "—"}</span> som förklarar vad NorthLedger är.
              </div>
            )}
          </>
        )}
