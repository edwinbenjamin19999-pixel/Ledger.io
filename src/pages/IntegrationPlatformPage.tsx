...
const MARKETPLACE_CATEGORIES: MarketplaceCategory[] = [
  ...
  { label: "AP Automation & Fakturahantering",
    integrations: [
      { id: "rillion", name: "Rillion", description: "Importera attesterade leverantörsfakturor direkt från Rillion till Ledger.io. Eliminera dubbelinmatning — fakturan bokförs automatiskt när den är attesterad.", tagline: "Automatisera fakturaattest och leverantörsflöde", status: "config", icon: FileText, badge: "enterprise" },
  ...
  { label: "Lön & HR-system",
    integrations: [
      { id: "quinyx", name: "Quinyx", description: "Synkar timesheet-data från Quinyx API → Ledger.io Tidrapportering → Lönekörning. Eliminerar manuell timeregistrering.", tagline: "Importera scheman och arbetade timmar direkt till lön", status: "config", icon: Clock },
  ...
  { label: "Lagerhantering",
    integrations: [
      { id: "ongoing-wms", name: "Ongoing WMS", description: "Webhook från Ongoing → uppdaterar Lagerredovisning i Ledger.io med inleveranser, utleveranser, lagervärde. Dubbel-bokföring sker automatiskt.", tagline: "Synka lagersaldon och transaktioner i realtid", status: "config", icon: Package },
    ],
  },
  ...
  { label: "Automation & Webhooks",
    integrations: [
      { id: "zapier", name: "Zapier", description: "Ledger.io Zapier App med triggers: ny_verifikation, ny_faktura, betalning_mottagen, anomali_detekterad, lönekörning_klar. Actions: skapa_faktura, bokför_kvitto.", tagline: "Koppla Ledger.io till 5000+ appar utan kod", status: "config", icon: Zap },
  ...
  { label: "Kommunikation & Notifieringar",
    integrations: [
      { id: "slack", name: "Slack", description: "Ledger.io skickar Slack-meddelanden vid: förfallen faktura, anomali, likviditetsprognos under gränsvärde, lönedeadline, momsdeklaration. Konfigurerbara kanalval per alert-typ.", tagline: "Skicka ekonomialerts direkt till ditt Slack-workspace", status: "config", icon: MessageSquare },
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Koppla Ledger.io till dina system, hantera API-nycklar och övervaka trafik"
      />
    ...
    <div className="space-y-4 mt-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Hantera åtkomst till Ledger.io API</p>
        </div>
