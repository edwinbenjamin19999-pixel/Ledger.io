          ...
          return (
            ...
            >
              <input
                ...
                className="w-[14px] h-[14px] rounded-[3px] border-[1.5px] border-[#D1D5DB] accent-[#0B4F6C] cursor-pointer"
              ...
              <button
                ...
                className="text-[11px] font-medium text-[#0B4F6C] hover:text-[#1074A0] px-[8px] disabled:opacity-50 inline-flex items-center gap-1"
              >
  ...
  return (
    <div>
          ...
          const styles =
            kpi.variant === "green"
              ...
              : kpi.variant === "red"
                ...
                : { bg: "bg-[#FAFBFC]", border: "border-[#DFE4EA]", line: "bg-[#0B4F6C]" };
          return (
      ...
      <div className="bg-[#EFF6FF] border-[0.5px] border-[#B5D4F4] rounded-[12px] px-[14px] py-[10px] flex items-center gap-[10px]">
        <div className="w-[18px] h-[18px] rounded-full bg-[#0B4F6C] flex items-center justify-center flex-shrink-0">
        ...
        <button
          ...
          className="bg-[#0B4F6C] hover:bg-[#1074A0] text-[#E6F4FA] rounded-[8px] text-[11px] font-medium px-[12px] h-[32px] transition-colors flex-shrink-0"
        >
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t-[0.5px] border-[#E2E8F0] px-[16px] py-[10px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-[8px]">
            ...
            <button
              ...
              className="text-[12px] font-medium text-[#0B4F6C] hover:bg-[#EFF6FF] rounded-[8px] px-[12px] h-[32px]"
            >
              Schemalägg
            </button>
            <button
              type="button"
              onClick={() => navigate("/invoice-reminders")}
              className="bg-[#0B4F6C] hover:bg-[#1074A0] text-[#E6F4FA] rounded-[8px] text-[12px] font-medium px-[14px] h-[32px] transition-colors"
            >
              Skicka påminnelse
            </button>
          </div>
