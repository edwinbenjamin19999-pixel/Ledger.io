  ...
  return (
    <div className="min-h-screen bg-[#FAFBFC]">
      ...
      <main className="mx-auto max-w-6xl px-6 py-16 md:py-24">
        ...
        <section className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-600 md:text-lg">
            NorthLedger är i produktion och driver bokföring, fakturering och moms för riktiga
        ...
        <section className="mt-16 md:mt-20">
          <div className="rounded-[22px] border border-slate-900/[0.06] bg-white p-8 shadow-[0_20px_50px_rgba(15,23,42,0.06)] md:p-12">
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
              NorthLedger är idag en stabil och fungerande plattform för bokföring och
      ...
      <footer className="border-t border-slate-900/[0.06] py-8 text-center text-xs text-slate-500">
        © {new Date().getFullYear()} NorthLedger · Infrastructure for Swedish finance
      </footer>
    </div>
  );
};
