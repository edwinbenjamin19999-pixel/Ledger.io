  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F5F7FA] p-6">
      <div className="bg-white border-[0.5px] border-[#DFE4EA] rounded-[16px] p-8 max-w-md w-full text-center space-y-4">
        {state === "working" && <Loader2 className="h-8 w-8 text-[#1D4ED8] mx-auto animate-spin" />}
        ...
        <h1 className="text-base font-semibold text-[#1D4ED8]">
        ...
        {state === "error" && (
          <Button
            ...
            className="bg-[#1D4ED8] hover:bg-[#1D4ED8]/90 text-[#E6F4FA] rounded-[8px] h-[40px] text-[12px]"
          >
