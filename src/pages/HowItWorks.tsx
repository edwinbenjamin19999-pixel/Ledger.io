...
export default function HowItWorks() {
  useEffect(() => {
    ...
    document.title = "Hur NorthLedger fungerar | Transparens och kontroll";
    const meta = document.querySelector('meta[name="description"]');
    const prevDesc = meta?.getAttribute("content") || "";
    meta?.setAttribute(
      "content",
      "Faktisk beskrivning av vilka beslut NorthLedger fattar automatiskt, vilka som alltid kräver din godkänning, och hur korrigeringar hanteras.",
    );
    return () => {
  ...
  return (
    <>
      ...
      <PageHeader
        icon={Sparkles}
        title="Hur NorthLedger fungerar"
