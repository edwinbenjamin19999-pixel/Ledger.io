...
const WelcomePage = () => {
  ...
  const finish = async () => {
    ...
    toast.success("Allt klart. Här är din NorthLedger.");
    const { resolveDefaultLanding } = await import("@/lib/auth/resolveDefaultLanding");
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        {step === 1 && (
          <Card className="p-10 border-slate-100 shadow-sm">
            ...
            <h1 className="text-3xl font-medium text-slate-900 mb-3">Välkommen till NorthLedger — din AI-ekonom.</h1>
            <p className="text-slate-600 leading-relaxed mb-8">
              Ju mer du använder NorthLedger, desto smartare blir den. Vi lär oss ditt företag automatiskt.
            </p>
        ...
        {step === 5 && (
          <Card className="p-8 border-slate-100 shadow-sm">
            ...
            <div className="mt-8 rounded-lg bg-[#3b82f6]/5 border border-[#3b82f6]/20 p-4">
              <div className="text-sm text-slate-900 font-medium">Allt klart. Här är din NorthLedger.</div>
