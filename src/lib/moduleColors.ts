...
export const MODULE_COLORS = {
  ...
  fakturering: { solid: 'bg-[#3b82f6]',    light: 'bg-cyan-50',    text: 'text-[#3b82f6]',    border: 'border-cyan-200',    accent: '#3b82f6', darkBg: 'dark:bg-cyan-900/30' },
  ...
  bank:        { solid: 'bg-teal-600',     light: 'bg-teal-50',    text: 'text-teal-600',    border: 'border-teal-200',    accent: '#0d9488', darkBg: 'dark:bg-teal-900/30' },
  bolag:       { solid: 'bg-blue-600',     light: 'bg-blue-50',    text: 'text-blue-600',    border: 'border-blue-200',    accent: '#2563eb', darkBg: 'dark:bg-blue-900/30' },
