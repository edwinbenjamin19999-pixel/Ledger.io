...
export const INTEGRATIONS_BY_INDUSTRY: Record<string, IntegrationRecommendation[]> = {
  restaurant: [
    ...
    },
    {
      ...
      name: "Fortnox",
      category: "booking",
      description: "Migrera från Fortnox till NorthLedger — all historik följer med.",
      setupSteps: [
        "Gå till /migration i NorthLedger",
        "Välj Fortnox → OAuth",
        "Godkänn åtkomst",
      ],
      priority: "optional",
  ...
  hotel: [
    {
      ...
      setupSteps: [
        ...
        "Begär API-åtkomst till NorthLedger",
        "Klistra in nyckeln här",
      ],
  ...
  construction: [
    ...
    {
      id: "tidrapportering",
      name: "NorthLedger Tidrapportering",
      category: "industry",
