...
export const INTEGRATIONS_BY_INDUSTRY: Record<string, IntegrationRecommendation[]> = {
  restaurant: [
    ...
    },
    {
      ...
      name: "Fortnox",
      category: "booking",
      description: "Migrera från Fortnox till Cogniq — all historik följer med.",
      setupSteps: [
        "Gå till /migration i Cogniq",
        "Välj Fortnox → OAuth",
        "Godkänn åtkomst",
      ],
      priority: "optional",
